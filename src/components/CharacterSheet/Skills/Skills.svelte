...
<script>
    ...
    export let skills = [
        ...
        {name: 'Locks', value: 0},
        {name: 'Lore', value: 0, canSpecialize: true, specialization: ""},
        {name: 'Lore', value: 0, canSpecialize: true, specialization: ""},
        {name: 'Lore', value: 0, canSpecialize: true, specialization: ""},
        {name: 'Lore', value: 0, canSpecialize: true, specialization: ""},
        ...
        {name: 'Tradecraft', value: 0, canSpecialize: true, specialization: ""},
        {name: 'Tradecraft', value: 0, canSpecialize: true, specialization: ""},
        {name: 'Tradecraft', value: 0, canSpecialize: true, specialization: ""},
        {name: 'Tradecraft', value: 0, canSpecialize: true, specialization: ""},
...
<Section title="Skills" hint="{skillsHint}">
    ...
    {#each skills as skill}
        <div class="skill-line">
            ...
            {#if (skill.canSpecialize)}
                <span>(</span>
                <input type="text" maxlength="25" bind:value={skill.specialization}/>
                <span>)</span>
            {/if}
        </div>
    {/each}
